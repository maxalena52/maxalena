...
import { _ as characterPublicCopy, f as readingUrl, g as characterDisplayName, h as warningsList, i as useLibrary, l as goodreadsUrl, m as tropesList, n as Route, o as amazonUrl, v as cleanText, y as inferGenre } from "./_ssr/router-DqOoZbIV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_site.books._slug-XbgrunLJ.js
...
function BookDetailPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			book.sample_chapter && book.sample_chapter.trim() && !/^https?:/i.test(book.sample_chapter) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mx-auto mt-16 max-w-xl",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-display mb-4 text-3xl",
					children: "Excerpt"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "whitespace-pre-wrap leading-8 text-parchment",
					children: book.sample_chapter
				})]
			}),
