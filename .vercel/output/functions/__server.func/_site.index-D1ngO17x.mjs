...
import { c as featuredBook, d as parseReviews, f as readingUrl, i as useLibrary, m as tropesList, o as amazonUrl, s as authorCopy, u as groupBooks, y as inferGenre } from "./_ssr/router-DqOoZbIV.mjs";
import { n as BookGridSkeleton, t as BookCard } from "./_ssr/book-skeleton-B9tNf4gt.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_site.index-D1ngO17x.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								readingUrl(featured, settings) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									className: "btn btn-ghost",
									href: readingUrl(featured, settings),
									target: "_blank",
									rel: "noopener noreferrer",
									children: "Read Now"
								})
