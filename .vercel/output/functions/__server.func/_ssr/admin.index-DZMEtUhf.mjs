...
import { i as applyBookCopy, n as getBookPreviewForAdmin, r as saveBookPreview } from "./preview-CIDNfBJl.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.index-DZMEtUhf.js
...
function AdminPage() {
	...
	async function load() {
		...
		setBooks((b.data || []).map(applyBookCopy));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				className: "block text-sm text-taupe",
				children: ["Upload cover", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			coverSrc(book) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				src: coverSrc(book),
				alt: "",
