...
import { n as verifyAuthorSession } from "./admin-auth-Du6PQND0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.login-B63Y99NW.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Only the authorised author account can enter. Other addresses are refused."
			}),
