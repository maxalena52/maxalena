...
import { t as requireAuthor } from "./admin-auth-Du6PQND0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-YNL0WtKB.js
...
var tokenSchema = object({ accessToken: string().min(20) });
