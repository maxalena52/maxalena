...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DqOoZbIV.js
...
async function fetchBooks() {
	const { data, error } = await getSupabase().from("books").select("*").order("order_index", { ascending: true });
...
function readingUrl(book, settings = {}) {
	const custom = settings[`reading_url_${book.slug}`];
	if (isValidHttpUrl(custom)) return custom;
	if (isValidHttpUrl(book.sample_chapter)) return book.sample_chapter;
	return null;
}
...
var styles_default = "/assets/styles-DjZvS99A.css";
...
var $$splitComponentImporter$14 = () => import("../_site-CHXV7s_r.mjs");
var Route$14 = createFileRoute("/_site")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("./admin-rRckGftk.mjs");
var Route$13 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("../_site.index-D1ngO17x.mjs");
var Route$12 = createFileRoute("/_site/")({
...
var $$splitComponentImporter$11 = () => import("../_site.about-DRLH6rc7.mjs");
var Route$11 = createFileRoute("/_site/about")({
...
var $$splitComponentImporter$10 = () => import("../_site.books-CF0jU3k1.mjs");
var Route$10 = createFileRoute("/_site/books")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("../_site.characters-hzBJmyEq.mjs");
var Route$9 = createFileRoute("/_site/characters")({
...
var $$splitComponentImporter$8 = () => import("../_site.contact-FAQ_Rw7W.mjs");
var Route$8 = createFileRoute("/_site/contact")({
	head: () => ({ meta: [
		{ title: "Contact | Maxalena L." },
		{
			name: "description",
			content: "Public enquiries for Maxalena L. are currently closed."
		},
		{
			name: "robots",
...
var $$splitComponentImporter$7 = () => import("../_site.cookies-s05xrHvH.mjs");
var Route$7 = createFileRoute("/_site/cookies")({
...
var $$splitComponentImporter$6 = () => import("../_site.copyright-CvWHoFcT.mjs");
var Route$6 = createFileRoute("/_site/copyright")({
...
var $$splitComponentImporter$5 = () => import("../_site.privacy-DByNJV-S.mjs");
var Route$5 = createFileRoute("/_site/privacy")({
...
var $$splitComponentImporter$4 = () => import("../_site.terms-BtJoLZu8.mjs");
var Route$4 = createFileRoute("/_site/terms")({
...
var $$splitComponentImporter$3 = () => import("./admin.index-bMvbnKfP.mjs");
...
var $$splitComponentImporter$2 = () => import("./admin.login-BP0-rJ3t.mjs");
...
var $$splitComponentImporter$1 = () => import("../_site.books.index-D9hO_WJT.mjs");
var Route$1 = createFileRoute("/_site/books/")({
...
var $$splitComponentImporter = () => import("../_site.books._slug-XbgrunLJ.mjs");
var Route = createFileRoute("/_site/books/$slug")({
...
var SiteAboutRoute = Route$11.update({
	id: "/about",
	path: "/about",
	getParentRoute: () => SiteRoute
});
var SiteBooksRoute = Route$10.update({
	id: "/books",
	path: "/books",
	getParentRoute: () => SiteRoute
});
var SiteCharactersRoute = Route$9.update({
	id: "/characters",
	path: "/characters",
	getParentRoute: () => SiteRoute
});
var SiteContactRoute = Route$8.update({
	id: "/contact",
	path: "/contact",
	getParentRoute: () => SiteRoute
});
var SiteCookiesRoute = Route$7.update({
	id: "/cookies",
	path: "/cookies",
	getParentRoute: () => SiteRoute
});
var SiteCopyrightRoute = Route$6.update({
	id: "/copyright",
	path: "/copyright",
	getParentRoute: () => SiteRoute
});
var SitePrivacyRoute = Route$5.update({
	id: "/privacy",
	path: "/privacy",
	getParentRoute: () => SiteRoute
});
var SiteTermsRoute = Route$4.update({
	id: "/terms",
	path: "/terms",
	getParentRoute: () => SiteRoute
});
...
var SiteBooksIndexRoute = Route$1.update({
	id: "/",
	path: "/",
	getParentRoute: () => SiteBooksRoute
});
var SiteBooksRouteChildren = {
	SiteBooksSlugRoute: Route.update({
		id: "/$slug",
		path: "/$slug",
		getParentRoute: () => SiteBooksRoute
	}),
...
//#endregion
export { characterPublicCopy as _, useSettings as a, SiteHeader as b, featuredBook as c, parseReviews as d, readingUrl as f, characterDisplayName as g, warningsList as h, useLibrary as i, goodreadsUrl as l, tropesList as m, Route as n, amazonUrl as o, socialLinks as p, SiteFooter as r, authorCopy as s, router_exports as t, groupBooks as u, cleanText as v, inferGenre as y };
